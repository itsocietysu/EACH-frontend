...
export const SEND_FEED_DATA = 'each/EditForm/SEND_FEED_DATA';
export const SEND_MUSEUM_DATA = 'each/EditForm/SEND_MUSEUM_DATA';
export const SEND_DATA_SUCCESS = 'each/EditForm/SEND_DATA_SUCCESS';
export const SEND_DATA_ERROR = 'each/EditForm/SEND_DATA_ERROR';
